...
public class AOSWebAppModel extends AppModelBase {		private MICEShopNowLink MICEShopNowLink;
	private expensiveMouse expensiveMouse;
	...
	public AOSWebAppModel(TestObject contextTestObject) throws GeneralLeanFtException
	{
		...
		expensiveMouse = new expensiveMouse(contextTestObject, this);
		...
		public expensiveMouse expensiveMouse() { return expensiveMouse; }
	...
	public class expensiveMouse extends ImageNodeBase
	{

		
								public expensiveMouse(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
