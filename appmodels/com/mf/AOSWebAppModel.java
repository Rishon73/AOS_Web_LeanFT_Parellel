...
public class AOSWebAppModel extends AppModelBase {		private MICEShopNowLink MICEShopNowLink;
	private FetchImageImageId5600Image FetchImageImageId5600Image;
	private WebElement WebElement;
	private SaveToCartButton SaveToCartButton;
	private CheckOutBtnButton CheckOutBtnButton;
	
	public AOSWebAppModel(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AOSWebAppModel");
				MICEShopNowLink = new MICEShopNowLink(contextTestObject, this);
		FetchImageImageId5600Image = new FetchImageImageId5600Image(contextTestObject, this);
		WebElement = new WebElement(contextTestObject, this);
		SaveToCartButton = new SaveToCartButton(contextTestObject, this);
		CheckOutBtnButton = new CheckOutBtnButton(contextTestObject, this);
		rebuildDescriptions();
	}	

			public MICEShopNowLink MICEShopNowLink() { return MICEShopNowLink; }
		public FetchImageImageId5600Image FetchImageImageId5600Image() { return FetchImageImageId5600Image; }
		...
		public class MICEShopNowLink extends LinkNodeBase
	{

		
								public MICEShopNowLink(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().innerText("MICE Shop Now ").tagName("DIV").build();
			}catch(Exception e){
	...
	public class FetchImageImageId5600Image extends ImageNodeBase
	{

		
								public FetchImageImageId5600Image(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("fetchImage?image_id=5600");
		}
		...
		protected com.hp.lft.sdk.web.ImageDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ImageDescription.Builder().alt("").tagName("IMG").type(com.hp.lft.sdk.web.ImageType.NORMAL).index(8).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class WebElement extends WebElementNodeBase
	{
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().className("plus").innerText("").tagName("DIV").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
